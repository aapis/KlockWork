...
struct Theme {
    ...
    static public var textLabelBackground: Color = Color.black.opacity(0.05)
    static public var lightWhite: Color = .white.opacity(0.55)
    static public var lightBase: Color = Theme.base.opacity(0.55)
